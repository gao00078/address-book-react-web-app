...
export default class ItemDetail extends Component{
    ...
    render(){
        ...
        if(!this.props.contact){
            return(
            <div className="detail-profile"> Please select one contact from the Contacts List on the left</div>
            )
        } else {
            return (
            <div className = 'details'>
                ...
                <div>
                    ...
                    <div>DOB: {this.props.contact.dob}  (Age: {getAge(this.props.contact.dob )})</div>
                </div>
                 <hr/>
